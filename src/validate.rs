...
pub fn validate_project(project: &Project) {
      ...
      "definitions":{
        ...
        "scalar_variable":{
          ...
          "additionalItems":{
            ...
            "description":"Whether this is a cloud variable"
          },
          "maxItems":3
        },
        "list":{
          ...
          "properties":{
            ...
            "mutation":{
              ...
              "properties":{
                ...
                "warp":{
                  "$ref":"#/definitions/boolOrOptBoolString"
                },
                "hasnext":{
                  "$ref":"#/definitions/boolOrOptBoolString"
                }
    ...
    let project_json_parsed: Value =
        serde_json::from_str(&project_json).expect("Invalid JSON blob");
    let result = compiled_schema.validate(&project_json_parsed);

    match result {
        Ok(()) => println!("JSON is valid."),
        Err(errors) => {
            println!("JSON is invalid. Errors:");
            for error in errors {
                println!("{}", error);
            }
        }
